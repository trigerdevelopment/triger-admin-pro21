...
@Component({
  selector: 'app-bank-paginator',
  templateUrl: './bank-paginator.component.html',
  styleUrls: ['./bank-paginator.component.css']
})
export class BankPaginatorComponent implements OnInit {
  ...
  constructor(private store: Store<BankMovState>,
  ...
  dispatchActions(pageNo:any){
    ...
    this.store.dispatch(bankActions.loadBankTransactionsByQuery({query:query}));
