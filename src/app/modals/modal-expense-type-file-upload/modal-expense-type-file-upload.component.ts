...
@Component({
  selector: 'app-modal-expense-type-file-upload',
  templateUrl: './modal-expense-type-file-upload.component.html',
  styleUrls: ['./modal-expense-type-file-upload.component.css']
})
export class ModalExpenseTypeFileUploadComponent implements OnInit {
...
subirArchivo(){
  ...
  uploadFiles(){
    ...
    this._uploadService.pushFileToStorage(this.selectedFile,'expense-type/upload-service').subscribe(
      event => {
        if (event.type === HttpEventType.UploadProgress) {
