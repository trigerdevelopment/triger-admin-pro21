...
import { loadInvoices } from 'src/app/customer/store/actions/invoice.actions';
...
export class PaginatorComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // this.store.pipe(select('query')).subscribe(res => {
  ...
  dispatchActions(pageNo:any){
    ...
    this.store.dispatch(loadProducts({query:query}));
